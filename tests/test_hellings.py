...
def test_hellings_1():
    ...
    result = grammar_in_graph(grammar, graph)
    expected = {(0, 1)}
...
def test_hellings_3():
    ...
    result = grammar_in_graph(grammar, graph, [0], [0, 1, 2, 3])
...
def test_hellings_4():
    ...
    result = grammar_in_graph(grammar, graph, [1], [0, 1, 2, 3])
...
def test_hellings_5():
    ...
    result = grammar_in_graph(grammar, graph, [0], [0, 1, 2, 3, 4])
...
def test_hellings_6():
    ...
    result = grammar_in_graph(grammar, graph, [1, 2, 3, 4], [0, 1, 2, 3, 4])
    expected = {
        (4, 4),
        (2, 4),
        (1, 2),
